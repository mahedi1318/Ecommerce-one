        ...
        <div className='py-8'>
            <div className="container">
                <div className="grid grid-cols-4 gap-8">
                    <div className='py-10 pl-5 h-[320px] bg-gradient-to-br from-black/90 to-black/70 text-white rounded-3xl relative flex items-end' >
                        <h2 className='text-white'>mahedi</h2>
                    </div>
